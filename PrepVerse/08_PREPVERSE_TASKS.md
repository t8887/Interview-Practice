...
2. In VS Code, open `Interview-Practice`, start Claude Code, paste this whole document, and say: *"Create `site/CLAUDE.md`, the four `.claude/commands/pv-*.md` files, and `_meta/pv-state.json` exactly as specified in §3; also copy docs 06/07/08 from my Downloads into `site/docs/` as BUILD_PLAN.md, ARCHITECTURE.md, TASKS.md."*
